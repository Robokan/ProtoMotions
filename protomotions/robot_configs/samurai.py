...
@dataclass
class SamuraiRobotConfig(RobotConfig):
    """
    Red Samurai robot: auto-generated from the rigged character via
    data/scripts/rig2mjcf.py (see SAMURAI_ROBOT_PLAN.md). Same 23-body /
    66-DOF topology and naming as soma23, with the character's proportions,
    skin-fit collision capsules and 75 kg mass. Derived from SOMASkeleton30 by dropping 7 leaf end-effector
    ...
    asset: RobotAssetConfig = field(
        default_factory=lambda: RobotAssetConfig(
            asset_file_name="mjcf/samurai.xml",
            usd_asset_file_name="usd/samurai/samurai.usda",
