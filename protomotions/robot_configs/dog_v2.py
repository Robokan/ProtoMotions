...
class DogV2RobotConfig(RobotConfig):
    ...
    # Commandable PD-target range per dof, centered on a LITERAL corpus
    # stance frame (clip-1 simframes frame 8768: joint speed 0.02 rad/s,
    # root stationary, feet grounded) so the zero-action pose is a REAL
    # standing pose of the dog. Per-dof medians and arc-midpoints both
    # compose into chimera non-poses (front legs thrown forward, hind legs
    # curled; Eric, 2026-08-24) because joints are centered independently.
    # Half-range covers the clip's excursion each side +15%, capped +-pi.
    # Derived from data/dog_clip1_amp_simframes -- REGENERATE with the
    # training corpus.
    action_scaling_limits: Dict[str, tuple] = field(
        default_factory=lambda: {
            r"Spine_x": (-3.207, 3.077),
            r"Spine_y": (-0.311, 0.755),
            r"Spine_z": (-6.075, 0.208),
            r"Spine1_x": (-3.080, 3.203),
            r"Spine1_y": (-1.181, 1.553),
            r"Spine1_z": (-1.694, 0.999),
            r"Neck_x": (-1.060, 1.014),
            r"Neck_y": (-1.360, 1.504),
            r"Neck_z": (-1.852, 1.279),
            r"Head_x": (-0.419, 3.762),
            r"Head_y": (-1.412, 1.731),
            r"Head_z": (-2.468, 2.130),
            r"LeftShoulder_x": (-2.667, -1.835),
            r"LeftShoulder_y": (-0.412, 0.035),
            r"LeftShoulder_z": (-1.449, -0.365),
            r"LeftArm_x": (-0.672, 5.612),
            r"LeftArm_y": (-1.674, 3.661),
            r"LeftArm_z": (-1.429, 4.854),
            r"LeftForeArm_x": (-2.710, 2.954),
            r"LeftForeArm_y": (-2.371, 1.822),
            r"LeftForeArm_z": (-4.035, 2.248),
            r"LeftHand_x": (-3.172, 3.111),
            r"LeftHand_y": (-1.645, 0.992),
            r"LeftHand_z": (-1.837, 1.321),
            r"RightShoulder_x": (-1.310, -0.475),
            r"RightShoulder_y": (-0.415, 0.086),
            r"RightShoulder_z": (0.391, 1.670),
            r"RightArm_x": (-3.056, 3.227),
            r"RightArm_y": (-3.991, 1.691),
            r"RightArm_z": (-2.048, 4.235),
            r"RightForeArm_x": (-2.952, 2.678),
            r"RightForeArm_y": (-1.180, 1.812),
            r"RightForeArm_z": (-4.126, 2.157),
            r"RightHand_x": (-3.131, 3.152),
            r"RightHand_y": (-0.966, 1.272),
            r"RightHand_z": (-1.684, 1.311),
            r"LeftUpLeg_x": (-0.948, 0.474),
            r"LeftUpLeg_y": (-0.646, 1.083),
            r"LeftUpLeg_z": (-2.889, -1.424),
            r"LeftLeg_x": (-1.634, 1.392),
            r"LeftLeg_y": (-0.301, 0.986),
            r"LeftLeg_z": (-0.547, 3.249),
            r"LeftFoot_x": (-0.091, 0.186),
            r"LeftFoot_y": (-0.541, 0.198),
            r"LeftFoot_z": (-1.006, 2.591),
            r"RightUpLeg_x": (-1.382, 1.011),
            r"RightUpLeg_y": (-0.567, 0.747),
            r"RightUpLeg_z": (-3.033, -1.414),
            r"RightLeg_x": (-1.761, 1.659),
            r"RightLeg_y": (-0.999, 0.592),
            r"RightLeg_z": (-0.726, 3.262),
            r"RightFoot_x": (-0.197, 0.254),
            r"RightFoot_y": (-0.252, 0.333),
            r"RightFoot_z": (-1.047, 3.181),
            r"Tail_x": (2.481, 8.764),
            r"Tail_y": (-1.774, 3.248),
            r"Tail_z": (-3.606, 2.074),
            r"Tail1_x": (-14.906, -8.623),
            r"Tail1_y": (-1.426, 1.407),
            r"Tail1_z": (-1.880, 1.767),
        }
    )
