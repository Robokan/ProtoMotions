...
def robot_config(robot_name: str, **updates) -> RobotConfig:
    ...
    elif robot_name == "tiger":
        from protomotions.robot_configs.tiger import TigerRobotConfig

        config = TigerRobotConfig()
    elif robot_name == "raptor":
        from protomotions.robot_configs.raptor import RaptorRobotConfig

        config = RaptorRobotConfig()
    elif robot_name == "utahraptor":
        from protomotions.robot_configs.utahraptor import UtahraptorRobotConfig

        config = UtahraptorRobotConfig()
    elif robot_name == "go2":
