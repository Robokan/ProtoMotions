#!/bin/bash
# Demo: MaskedMimic with Sparse Keypoint Control
...
CHECKPOINT="${1:-results/masked_mimic_g1_isaaclab/last.ckpt}"
...
echo "============================================"
echo "ProtoMotions - MaskedMimic Demo"
echo "============================================"
...
echo ""
echo "MaskedMimic inpaints the full body motion!"
echo ""
