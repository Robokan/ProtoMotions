...
def env_config(robot_cfg: RobotConfig, args: argparse.Namespace) -> EnvConfig:
    ...
    return EnvConfig(
        ...
        # 10% of resets spawn in random orientation + random joints for get-up training
        random_getup_prob=0.1,
    )
...
def apply_inference_overrides(
    ...
    env_cfg.random_getup_prob = 0.0  # disable get-up during inference
